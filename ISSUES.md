...
**Total: 25 pts.** The subject caps the bonus part at +5 above the 14-pt floor;
...
| 2026-05-18 | ValGSgit (PO) | API key session validation security fix documented. Documentation update target set to June 15, 2026. |
